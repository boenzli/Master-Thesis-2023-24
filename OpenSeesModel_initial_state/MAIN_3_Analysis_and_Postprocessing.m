...
% Material properties
%   Initial properties ( Lourenço et al. 2022)
% E = 4.648e9;          % Youngs modulus [Pa]
% Gs = 1.937e9;         % Shear modulus [Pa]
% fc = 7.15e6;          % Compressive strength [Pa]
% mus = 0.65;           % Initial friction coefficient [-]
% coh = 1.8e5;          % Cohesion [Pa]
% rho = 1800;           % Material density [kg/m^3]

%   Second possibility (NTC08 2009)
